...
const AdminResourceList = () => {
  ...
  return (
    <>
      ...
      <Button size="sm" outline className="mx-5" color="primary" onClick={sortButtonDate}>Oldest First</Button>
      <Button size="sm" outline color="primary" className="mx-5" onClick={sortButtonMostSaves}>Most Saves</Button>
