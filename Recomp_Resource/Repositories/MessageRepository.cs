        ...
        private Message NewMessageFromReader(SqlDataReader reader)
        {
            return new Message()
            {
                ...
                Sender = new User()
                {
                    ...
                    Weight = DbUtils.GetDecimal(reader, "SWeight"),
                    Height = DbUtils.GetString(reader, "SHeight"),
                    BFPercentage = DbUtils.GetDecimal(reader, "SBFPercentage"),
                    BMR = DbUtils.GetInt(reader, "SBMR"),
                ...
                Recipient = new User()
                {
                    ...
                    Weight = DbUtils.GetDecimal(reader, "RWeight"),
                    Height = DbUtils.GetString(reader, "RHeight"),
                    BFPercentage = DbUtils.GetDecimal(reader, "RBFPercentage"),
                    BMR = DbUtils.GetInt(reader, "RBMR"),
